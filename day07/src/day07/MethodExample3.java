...
public class MethodExample3 {
	 ...
	 * 
	 * 2. 매개 변수는 여러개 입력받을 수 있지만 반환값은 오로지 하나여야 합니다.
	 * 
	 * 3. return 키워드를 사용해 반환 값을 지정할 수 있습니다.
	 * 
	 * 4. 전달할 반환값을 반환 유형이라고 부릅니다.
	 * 
	 ...
	 * 	  분기가 아닌 return 구문 하단에는 추가코드를 작성하면 경고가 뜹니다.
	 */
	...
	public static void main(String[] args) {
		...
		int result2 = add(add(2,4),add(5,6)); // -> add(6,11);
		...
		callMyName("김재원");// 반환값이 void이며 return구문 실행 안됨
